...
- Create Angular project with ng: `ng new angular_christianchurchmembercontrol.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`angular_christianchurchmembercontrol.client.esproj`).
